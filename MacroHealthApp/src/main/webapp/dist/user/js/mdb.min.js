...
jQuery.easing.jswing = jQuery.easing.swing, jQuery.extend(jQuery.easing, {
	...
	return function(t, e, i, n) {
		...
		function o(t, i, n, a) {
			...
			t = Math.min(t, 1), n = Math.min(n, 1), t = Math.max(t, 0), n = Math.max(n, 0);var w = y ? new Float32Array(v) : new Array(v),
				k = !1,
				S = function(e) {
			...
			for (var i = v.State.calls[t][0], a = v.State.calls[t][1], o = v.State.calls[t][2], s = v.State.calls[t][4], l = !1, u = 0, c = i.length; c > u; u++) {
				...
				if (e || o.loop || ("none" === o.display && y.setPropertyValue(h, "display", o.display), "hidden" === o.visibility && y.setPropertyValue(h, "visibility", o.visibility)), !0 !== o.loop && (d.queue(h)[1] === n || !/\.velocityQueueEntryFlag/i.test(d.queue(h)[1])) && r(h)) {
					...
					d.each(y.Lists.transforms3D, function(t, e) {
						...
						r(h).transformCache[e] !== n && new RegExp("^\\(" + i + "[^.]").test(a) && (f = !0,
						delete r(h).transformCache[e]
						)
					}), o.mobileHA && (f = !0,
					delete r(h).transformCache.translate3d
					), f && y.flushTransformCache(h), y.Values.removeClass(h, "velocity-animating")
				}
		...
		if (!(7 >= c)) {
			...
			var y = v.CSS = {
					...
					register : function() {
						...
						if (c)
							for (i in y.Hooks.templates) {
								a = (n = y.Hooks.templates[i])[0].split(" ");var r = n[1].match(y.RegEx.valueSplit);
					...
					registered : {
						clip : function(t, e, i) {
							...
							case "name":
								...
								var n;
								return y.RegEx.wrappedValueAlreadyExtracted.test(i) ? n = i : n = (n = i.toString().match(y.RegEx.valueUnwrap)) ? n[1].replace(/,(\s+)?/g, " ") : i, n;case "inject":
								return "rect(" + i + ")"
							}
						},
						blur : function(t, e, i) {
						...
						opacity : function(t, e, i) {
							if (8 >= c) switch (t) {
								case "name":
									...
									return n ? n[1] / 100 : 1;case "inject":
						...
						for (t = 0; t < y.Lists.colors.length; t++) !function() {
								...
								y.Normalizations.registered[e] = function(t, i, a) {
									...
									case "name":
										...
										return 8 >= c || 3 !== r.split(" ").length || (r += " 1"), r;case "inject":
				...
				setPropertyValue : function(t, i, n, a, o) {
					...
					else if (y.Normalizations.registered[i] && "transform" === y.Normalizations.registered[i]("name", t)) y.Normalizations.registered[i]("inject", t, n), s = "transform", n = r(t).transformCache[i];else {
						if (y.Hooks.registered[i]) {
							var l = i,
								u = y.Hooks.getRoot(i);
				...
				function o() {
					function t(t) {
						...
						if ("scroll" === P) {
							...
							"none" === r(o).opts.display && (r(o).opts.display = "auto"), "hidden" === r(o).opts.visibility && (r(o).opts.visibility = "visible"), r(o).opts.loop = !1, r(o).opts.begin = null, r(o).opts.complete = null, w.easing ||
							delete u.easing
							, w.duration ||
							delete u.duration
							...
							for (var _ in r(o).tweensContainer && !0 === r(o).isAnimating && (D = r(o).tweensContainer), d.each(b, function(t, e) {
								...
								var R = h(b[_]),
									...
									E = R[1],
									N = R[2];
								_ = y.Names.camelCase(_);var B = y.Hooks.getRoot(_),
									W = !1;
								if (r(o).isSVG || "tween" === B || !1 !== y.Names.prefixCheck(B)[1] || y.Normalizations.registered[B] !== n) {
									...
									if (N = (H = p(_, N))[0], q = H[1], z = (H = p(_, z))[0].replace(/^([+-\/*])=/, function(t, e) {
											return Y = e, ""
										}), j = H[1], N = parseFloat(N) || 0, z = parseFloat(z) || 0, "%" === j && (/^(fontSize|lineHeight)$/.test(_) ? (z /= 100, j = "em") : /^scale/.test(_) ? (z /= 100, j = "") : /(Red|Green|Blue)$/i.test(_) && (z = z / 100 * 255, j = "")), /[\/*]/.test(Y))
										j = q;
									else if (q !== j && 0 !== N)
										if (0 === z)
											j = q;else {
				...
				if (f.isWrapped(this) ? (c = !1, p = 0, m = this, h = this) : (c = !0, p = 1, m = k ? arguments[0].elements || arguments[0].e : arguments[0]), m = a(m)) {
					...
					case "stop":
						d.each(m, function(t, e) {
							r(e) && r(e).delayTimer && (clearTimeout(r(e).delayTimer.setTimeout), r(e).delayTimer.next && r(e).delayTimer.next(),
						...
						return d.each(v.State.calls, function(t, e) {
								...
								u(e, !0)
							}), A.promise && A.resolver(m)), t();default:
					...
					v.Redirects["slide" + e] = function(t, i, a, r, o, s) {
						...
						l.display === n && (l.display = "Down" === e ? "inline" === v.CSS.Values.getDisplayType(t) ? "inline-block" : "block" : "none"), l.begin = function() {
							for (var i in u && u.call(o, o), h) {
								f[i] = t.style[i];var n = v.CSS.getPropertyValue(t, i);
								h[i] = "Down" === e ? [ n, 0 ] : [ 0, n ]
							}
				...
				t.defaults.line = {
					...
					updateBezierControlPoints : function() {
						...
						if (r.dataset._model.spanGaps && (s = s.filter(function(t) {
							...
							})), "monotone" === r.dataset._model.cubicInterpolationMode) e.splineCurveMonotone(s);else
					...
					if ("object" != typeof i || "[object HTMLImageElement]" !== (o = i.toString()) && "[object HTMLCanvasElement]" !== o) {
						if (!(isNaN(n) || n <= 0)) {
							...
							default:
								...
								break;case "triangle":
								e.beginPath(), d = (s = 3 * n / Math.sqrt(3)) * Math.sqrt(3) / 2, e.moveTo(a - s / 2, r + d / 3), e.lineTo(a + s / 2, r + d / 3), e.lineTo(a, r - 2 * d / 3), e.closePath(), e.fill();
								break;case "rect":
								c = 1 / Math.SQRT2 * n, e.beginPath(), e.fillRect(a - c, r - c, 2 * c, 2 * c), e.strokeRect(a - c, r - c, 2 * c, 2 * c);
								...
								break;case "rectRot":
								c = 1 / Math.SQRT2 * n, e.beginPath(), e.moveTo(a - c, r), e.lineTo(a, r + c), e.lineTo(a + c, r), e.lineTo(a, r - c), e.closePath(), e.fill();
								break;case "cross":
								e.beginPath(), e.moveTo(a, r + n), e.lineTo(a, r - n), e.moveTo(a - n, r), e.lineTo(a + n, r), e.closePath();
								break;case "crossRot":
								e.beginPath(), l = Math.cos(Math.PI / 4) * n, u = Math.sin(Math.PI / 4) * n, e.moveTo(a - l, r - u), e.lineTo(a + l, r + u), e.moveTo(a - l, r + u), e.lineTo(a + l, r - u), e.closePath();
								break;case "star":
								e.beginPath(), e.moveTo(a, r + n), e.lineTo(a, r - n), e.moveTo(a - n, r), e.lineTo(a + n, r), l = Math.cos(Math.PI / 4) * n, u = Math.sin(Math.PI / 4) * n, e.moveTo(a - l, r - u), e.lineTo(a + l, r + u), e.moveTo(a - l, r + u), e.lineTo(a + l, r - u), e.closePath();
								break;case "line":
				...
				t.types = {}, t.instances = {}, t.controllers = {}, e.extend(t.prototype, {
					...
					buildOrUpdateControllers : function() {
						...
						if (e.each(i.data.datasets, function(e, r) {
								...
								if (o.type || (o.type = e.type || i.config.type), n.push(o.type), o.controller) o.controller.updateIndex(r);else {
					...
					destroy : function() {
						...
						l && (s.unbindEvents(), e.clear(s), n.releaseContext(s.ctx), s.canvas = null, s.ctx = null), i.notify(s, "destroy"),
			...
			e.exports = function(t) {
				...
				function n(t, e) {
					...
					if (n) {
						var a = n.listeners,
							r = a.indexOf(e);
						-1 !== r && a.splice(r, 1), a.length > 0 || (i.forEach(function(e) {
							delete t[e]
						}),
						delete t._chartjs
						)
						...
						if (r.display) {
							...
							if (e.each(a.ticks, function(t, n) {
								...
								var T,
									D,
									F = 0;
								if (g) T = a.left + (a.right - a.left) / 2, D = "bottom" === r.position ? a.bottom - x.size / 2 : a.top + x.size / 2;else {
			...
			e.exports = function(t) {
				...
				t.defaults.global.tooltips = {
					...
					getCaretPosition : function(t, e, i) {
						...
						else if ("left" === c ? (n = (a = f + d + u) - u, r = a + u) : "right" === c ? (n = (a = f + g - d - u) - u, r = a + u) : (n = (a = f + g / 2) - u, r = a + u), "top" === h) s = (o = p) - u, l = o;else {
							s = (o = p + m) + u, l = o;
							var v = r;
							r = n, n = v
						}
				...
				return {
					acquireContext : function(t, e) {
						...
						return i && i.canvas === t ? (function(t, e) {
							...
							if (null === a || "" === a)
								if ("" === t.style.height)
									t.height = t.width / (e.options.aspectRatio || 2);else {
									var s = n(t, "height");
									void 0 !== o && (t.height = s)
							}
						}(t, e), i) : null
				...
				return t.defaults.global.legend = {
							...
							if (n.display) {
								...
								e.each(i.legendItems, function(e, a) {
									var f = c.measureText(e.text).width,
										...
										m = d.x,
										v = d.y;
									x ? m + g >= l && (v = d.y += w, d.line++, m = d.x = i.left + (l - u[d.line]) / 2) : v + w > i.bottom && (m = d.x = m + i.columnWidths[d.line] + r.padding, v = d.y = i.top + r.padding, d.line++), function(e, i, a) {
										if (!(isNaN(b) || b <= 0)) {
						...
						beforeUpdate : function(n) {
							var a = n.options.legend,
								o = n.legend;
							a ? (a = e.configMerge(t.defaults.global.legend, a), o ? (i.configure(n, o, a), o.options = a) : r(n, a)) : o && (i.removeBox(n, o),
							delete n.legend
							)
						},
				...
				return t.defaults.global.title = {
						...
						beforeUpdate : function(n) {
							var r = n.options.title,
								o = n.titleBlock;
							r ? (r = e.configMerge(t.defaults.global.title, r), o ? (i.configure(n, o, r), o.options = r) : a(n, r)) : o && (t.layoutService.removeBox(n, o),
							delete n.titleBlock
							)
						}
				}
					...
					n = t.LinearScaleBase.extend({
						...
						getTickLimit : function() {
							...
							if (this.isHorizontal())
								i = Math.min(n.maxTicksLimit ? n.maxTicksLimit : 11, Math.ceil(this.width / 50));else {
						...
						this.options.pointLabels.display ? function(t) {
							...
							for (i = 0; i < g; i++) {
								s = t.getPointPosition(i, u), h = t.ctx, f = l.size, p = t.pointLabels[i] || "", n = e.isArray(p) ? {
									...
									h : f
								}, t._pointLabelSizes[i] = n;var m = t.getIndexAngle(i),
									v = e.toDegrees(m) % 360,
									b = o(v, s.x, n.w, 0, 180),
							...
							e.each(t.ticks, function(r, s) {
								if (s > 0 || n.reverse) {
									...
									if (o.display && 0 !== s && function(t, i, n, r) {
											var o = t.ctx;
											if (o.strokeStyle = e.getValueAtIndexOrDefault(i.color, r - 1), o.lineWidth = e.getValueAtIndexOrDefault(i.lineWidth, r - 1), t.options.gridLines.circular) o.beginPath(), o.arc(t.xCenter, t.yCenter, n, 0, 2 * Math.PI), o.closePath(), o.stroke();else {
												var s = a(t);
												if (0 === s) return;
												o.beginPath();
			...
			n = "function" == typeof n ? n : window.moment, e.exports = function(t) {
				...
				t.Ticks.generators.time = function(t, e) {
					var i,
						a,
						r = t.isoWeekday;
					return "week" === t.unit && !1 !== r ? (i = n(e.min).startOf("isoWeek").isoWeekday(r).valueOf(), a = n(e.max).startOf("isoWeek").isoWeekday(r), e.max - a > 0 && a.add(1, "week"), a = a.valueOf()) : (i = n(e.min).startOf(t.unit).valueOf(), a = n(e.max).startOf(t.unit), e.max - a > 0 && a.add(1, t.unit), a = a.valueOf()), function(t, e, i) {
							var a = [];
							if (t.maxTicks) {
								var r = t.stepSize;
					...
					t(".wow").each(function() {
						if ("visible" != t(this).css("visibility") && (i + n - 100 > a(this) && n < a(this) || i + n - 100 > a(this) + t(this).height() && n < a(this) + t(this).height() || i + n == t(document).height() && a(this) + 100 > t(document).height())) {
							...
							if (o) {
								...
								var s = this;
								parseFloat(o);t(s).addClass("animated"), t(s).css({
									visibility : "visible"
								}), t(s).css({
									"animation-delay" : o
								}), t(s).css({
								...
								t(this).addClass("animated"), t(this).css({
									...
									"animation-name" : e[r]
								});l = 1e3 * t(this).css("animation-duration").slice(0, -1), s = this;setTimeout(function() {
									t(s).removeClass("animated")
								}, l)
							}
						}
